...
import builders.marketplace.business.logic.backend.operations.stubs.AdvertReadStub
...
object AdvertRead: IOperation<AdvertBackendContext> by pipeline ({
    execute(InitializePipeline)

    execute(AdvertReadStub)
